...
extern "C" JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void*) {
  ...
  jclass localCls = env->FindClass("app/ehtudo/iptv/player/MPVLib$EventListener");
  if (!localCls) {
...
Java_app_ehtudo_iptv_player_MPVLib_nativeCreate(JNIEnv*, jclass) {
...
Java_app_ehtudo_iptv_player_MPVLib_nativeInitialize(JNIEnv*, jclass, jlong h) {
...
Java_app_ehtudo_iptv_player_MPVLib_nativeTerminateDestroy(JNIEnv* env, jclass, jlong h) {
...
Java_app_ehtudo_iptv_player_MPVLib_nativeErrorString(JNIEnv* env, jclass, jint code) {
...
extern "C" JNIEXPORT void JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeSetEventListener(
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeRequestLogMessages(
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeObserveProperty(
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeUnobserveProperty(
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeCommand(
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeCommandString(
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeSetOptionString(
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeSetPropertyString(
    JNIEnv* env, jclass, jlong h, jstring jName, jstring jValue) {
  auto* ctx = lookupCtx(h);
  if (!ctx) return MPV_ERROR_INVALID_PARAMETER;
  const char* name  = env->GetStringUTFChars(jName, nullptr);
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeSetPropertyDouble(
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeSetPropertyLong(
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeSetPropertyBoolean(
...
extern "C" JNIEXPORT jstring JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeGetPropertyString(
...
Java_app_ehtudo_iptv_player_MPVLib_nativeGetPropertyDouble(
    JNIEnv* env, jclass, jlong h, jstring jName) {
  auto* ctx = lookupCtx(h);
  if (!ctx) return nullptr;
  const char* name = env->GetStringUTFChars(jName, nullptr);
...
extern "C" JNIEXPORT jobject JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeGetPropertyLong(
    JNIEnv* env, jclass, jlong h, jstring jName) {
  auto* ctx = lookupCtx(h);
  if (!ctx) return nullptr;
  const char* name = env->GetStringUTFChars(jName, nullptr);
...
extern "C" JNIEXPORT jobject JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeGetPropertyBoolean(
    JNIEnv* env, jclass, jlong h, jstring jName) {
  auto* ctx = lookupCtx(h);
  if (!ctx) return nullptr;
  const char* name = env->GetStringUTFChars(jName, nullptr);
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeAttachSurface(
...
extern "C" JNIEXPORT jint JNICALL
Java_app_ehtudo_iptv_player_MPVLib_nativeDetachSurface(
